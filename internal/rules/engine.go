...
var allowedRules = map[string]ruleMeta{
	...
	"NO_SALES": {
		...
		FallbackTitle:        "Нет продаж 14 дней",
		FallbackDescription:  "Рекомендуем проверить ассортимент, цены или модель продаж.",
		FallbackReasonText:   "У продавца нет продаж 14 или более дней",
	},
	"INACTIVE_SELLER": {
		RuleID:               3,
		RecommendationTypeID: 6,
		FallbackTitle:        "Вернитесь к управлению продажами",
		FallbackDescription:  "Вы давно не заходили в кабинет. Проверьте товары, остатки и продажи.",
		FallbackReasonText:   "Продавец не заходил 7 или более дней",
	},
	"OUT_OF_STOCK": {
		RuleID:               4,
		RecommendationTypeID: 5,
		FallbackTitle:        "Пополните остатки",
		FallbackDescription:  "У части товаров закончились остатки. Пополните их, чтобы не терять продажи.",
		FallbackReasonText:   "Есть товары без остатков",
	},
}
